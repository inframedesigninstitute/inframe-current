            ...
            <div className="lg:py-[30px] py-[30px]">
                ...
                <div className="max-w-[1320] mx-auto lg:px-6 px-3  ">
                    <div className="grid grid-cols-2 gap-12">
                        <div>
                            <img alt='' className="w-[100%] my-[30px] h-[300px] object-cover rounded-2xl" src="/mockTest.JPG" />
                            <div className="grid grid-cols-2 my-[25px] gap-5">
                                <img alt='' className="object-cover rounded-xl" src="/mockTest.JPG" />
                                <img alt='' className="object-cover rounded-xl" src="/mockTest.JPG" />
                            </div>
                            <div className="grid grid-cols-2 my-[25px] gap-5">
                                <img alt='' className="object-cover rounded-xl" src="/mockTest.JPG" />
                        ...
                        <div>
                            ...
                            <img alt='' className="w-[100%] my-[35px] h-[300px] object-cover rounded-2xl" src="/mockTest.JPG" />
                        </div>
